...
| POST | `/wallets/:id/fund` | Add initial or external liquidity to a wallet | Admin |
...
Use this admin-only operation to establish liquidity before the first
wallet-to-wallet supply or transfer:
